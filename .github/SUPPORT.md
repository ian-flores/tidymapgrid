# Getting help with tidymapgrid

Thanks for using tidymapgrid. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/tidymapgrid/issues) to make sure the 
